...
dependencies {
	...
	implementation(project(":knowledge-rag:knowledge-rag-adapter:knowledge-rag-adapter-inbound"))
	implementation(project(":knowledge-rag:knowledge-rag-adapter:knowledge-rag-adapter-outbound"))
