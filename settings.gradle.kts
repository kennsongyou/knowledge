...
include(
    ...
    ":knowledge-conversation:knowledge-conversation-adapter",
    ":knowledge-conversation:knowledge-conversation-app",
    ":knowledge-conversation:knowledge-conversation-bootstrap",
    ":knowledge-conversation:knowledge-conversation-domain",
